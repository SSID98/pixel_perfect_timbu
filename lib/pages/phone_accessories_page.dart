...
class PhoneAccessoriesPage extends StatefulWidget {
  static const String id = 'phone_accessories_page';

  const PhoneAccessoriesPage({
    super.key,
  });

  @override
  State<PhoneAccessoriesPage> createState() => _PhoneAccessoriesPageState();
}

class _PhoneAccessoriesPageState extends State<PhoneAccessoriesPage> {
  @override
    ...
    return Consumer<ItemManager>(
      builder: (context, itemManager, child) {
        return Scaffold(
          ...
          body: FutureBuilder(
            future: Future.wait(
                [itemManager.getFilteredProductData('phones & accessories')]),
